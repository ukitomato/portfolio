    ...
    return (
        <Container fluid id="research" className="research page">
            ...
            <Research
                ...
                url={'https://doi.org/10.1007/978-3-030-49062-1_10'}
                type={'User Interface'}
                term={'April 2019 - Present'}
                topic={
                    'Mask-Type Interface, Mutual-Capacitance-Sensor, Mouth Gesture, Hands-Free, Machine Learning'
                }
            />
            <Research
                name={
                ...
                term={'April 2019 - Present'}
                topic={
                    'Mobile Interaction, Hand Gesture, Smartwatch, Infrared Sensor, Machine Learning'
                }
            />
        </Container>
    );
